...
contract SimpleBank {
    ...
    function withdraw(uint256 withdrawAmount) public payable returns (uint256) {
        require(balances[msg.sender] > 0, "No Fund in account!");
        require(balances[msg.sender] >= withdrawAmount);
        // If the sender's balance is at least the amount they want to withdraw          // Subtract the amount from the sender's balance, and try to send that amount of ether
